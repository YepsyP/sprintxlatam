import imgFuture from './assets_public/img/future_shiping.jpeg'
import imgAboutHome from './assets_public/img/computadoras_importacion.jpeg'
        ...
        <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay={delay}>
            <div className="card">
                <div className="card-img">
                    <img src={`src/public_html/assets_public/img/${images}`} alt="" className="img-fluid" />
                </div>
    ...
    return (
        <div className="row gy-4 align-items-center features-item" data-aos="fade-up">
            ...
            <div className="col-md-5">
                <img src={`src/public_html/assets_public/img/${images}`} className="img-fluid" alt="" />
            </div>
